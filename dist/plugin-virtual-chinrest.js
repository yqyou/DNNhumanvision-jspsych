var jsPsychVirtualChinrest = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          <p>请您将拿出一张真实的信用卡放在屏幕上方，</p>
          <p>单击并拖动图像的右下角，直到它与屏幕上的信用卡大小相同。</p>
          <p>您可以使用与信用卡大小相同的任何卡，如会员卡或驾照，</p>
          <p>如果您无法使用真实的卡，可以使用直尺测量图像宽度至85.6毫米。</p>
          </div>`,
          },
          ...
          blindspot_prompt: {
              ...
              default: `
          <p>现在，我们将快速测量您和屏幕之间的距离。</p>
          <div style="text-align: left">
            <ol>
              <li>请把您的左手放在 <b>空格键上</b></li>
              <li>请用右手遮住右眼</li>
              <li>请用您的左眼专注于黑色方块。将注意力集中在黑色方块上.</li>
              <li> <span style="color: red; font-weight: bold;">红色的球</span>将从右向左移动，并将消失。当球一消失，就请按空格键</li>
            </ol>
          </div>
          <p>准备开始时，请按空格键。</p>
          `,
          ...
          viewing_distance_report: {
              ...
              default: "<p>根据您的反应，你坐在离屏幕<span id='distance-estimate' style='font-weight: bold;'></span> 的位置。</p><p>这大概是对的吗？</p>",
          },
